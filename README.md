# Examen Práctico Final — IS-403 · Temática 07: LAVANDERIA
...
export type NuevaOrden = unknown; // TODO: qué se necesita para crear la transacción
```
...
Corre en `http://localhost:3000` y expone: `GET /servicios`, `GET|POST /clientes`,
`GET|POST /ordenes`, `PATCH /ordenes/:id`. Visite `http://localhost:3000/`
